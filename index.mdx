...
|---|---|
| Official Account đã kết nối | Console → Official Account <a href="https://business.adflex.vn/console/oa" target="_blank" rel="noopener"><Icon icon="arrow-up-right-from-square" size={13} /></a> |
| Template ở trạng thái `ENABLE` | Console → Template <a href="https://business.adflex.vn/console/templates" target="_blank" rel="noopener"><Icon icon="arrow-up-right-from-square" size={13} /></a> |
| API key | Console → Cài đặt → API Keys <a href="https://business.adflex.vn/console/settings/api-keys" target="_blank" rel="noopener"><Icon icon="arrow-up-right-from-square" size={13} /></a> |
...
Console → Template <a href="https://business.adflex.vn/console/templates" target="_blank" rel="noopener"><Icon icon="arrow-up-right-from-square" size={13} /></a>.

Chức năng đó chạy ở chế độ development của Zalo: không tính phí, nhưng **chỉ gửi
được tới số quản trị viên của Official Account**. Đây là giới hạn của Zalo, không
phải của AdFlex. Gửi tới số bất kỳ ở chế độ này trả mã `-127`.
</Warning>
