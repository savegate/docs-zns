...
Template do **bạn đăng ký trực tiếp với Zalo** và Zalo kiểm duyệt. AdFlex đồng bộ
template bạn đã khai báo trên Zalo về hệ thống, sẵn sàng cho việc gửi tin.
...
buộc. Chi tiết xem tài liệu Zalo <a href="https://developers.zalo.me/docs" target="_blank" rel="noopener"><Icon icon="arrow-up-right-from-square" size={13} /></a>.
...
<Steps>
  <Step title="Soạn template trên Zalo">
    ...
    Khai báo đầy đủ components và parameters. Hướng dẫn chi tiết xem tài liệu Zalo
    <a href="https://developers.zalo.me/docs" target="_blank" rel="noopener"><Icon icon="arrow-up-right-from-square" size={13} /></a>.
  </Step>
...
- Nội dung template chỉnh sửa trên Zalo, sau đó đồng bộ lại để AdFlex nhận bản mới.
