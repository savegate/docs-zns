...
Bạn tự đăng ký template với Zalo và chờ Zalo duyệt. AdFlex đồng bộ thông tin
template về hệ thống để bạn tra cứu và dùng khi gửi tin.

API này chỉ **đọc**. Không tạo, sửa hay xoá template qua đây — mọi thay đổi thực
hiện phía Zalo, sau đó đồng bộ lại.
...
<Note>
Endpoint không trả về giá tin. Chi phí xem tại Console → Template <a href="https://business.adflex.vn/console/templates" target="_blank" rel="noopener"><Icon icon="arrow-up-right-from-square" size={13} /></a>.
</Note>
...
```mermaid
stateDiagram-v2
    [*] --> PENDING_REVIEW: Bạn đăng ký template với Zalo
...
<Warning>
Nguồn sự thật về template là phía Zalo. Trạng thái có thể thay đổi bất kỳ lúc nào và
AdFlex chỉ phản ánh lại bản đã đồng bộ gần nhất.

Vừa đăng ký template mới hoặc vừa được Zalo duyệt mà chưa thấy ở đây, bấm **Đồng bộ**
trong Console → Template <a href="https://business.adflex.vn/console/templates" target="_blank" rel="noopener"><Icon icon="arrow-up-right-from-square" size={13} /></a> để lấy về ngay.
</Warning>
