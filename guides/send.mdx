---
title: "Gửi tin"
description: "Gửi một tin hoặc gửi batch"
---
...
AdFlex kiểm tra hạn mức tài khoản cho toàn batch trước khi xếp hàng. Vượt hạn mức trả
`402` và không tin nào được gửi.

Khuyến nghị chia batch 100–200 người nhận để giảm chi phí thử lại khi lỗi mạng.
